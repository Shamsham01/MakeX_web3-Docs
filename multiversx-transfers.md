...
- [ESDT Transfer](#esdt-transfer)
- [NFT Transfer](#nft-transfer)
- [Multi NFT Transfer](#multi-nft-transfer)
- [SFT Transfer](#sft-transfer)
- [Meta-ESDT Transfer](#meta-esdt-transfer)
- [Free NFT Mint Airdrop](#free-nft-mint-airdrop)
- [ESDT Airdrop (Distribute Rewards to NFT Owners)](#esdt-airdrop)
...
Sends a Meta-ESDT token from your automation wallet to a recipient. Meta-ESDTs are tokens with properties of both fungible and non-fungible tokens.
...
|---|---|---|---|
| **recipient** | Text | Yes | The recipient's wallet address (e.g., `erd1...`). |
| **tokenIdentifier** | Text | Yes | The Meta-ESDT token identifier (e.g., `LKFARM-9d1ea8`). |
| **nonce** | Number | Yes | The token nonce (specific edition/instance of the Meta-ESDT). |

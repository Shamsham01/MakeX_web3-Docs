...
2. **Configure the subscription** — Go to the [MakeX-web3](https://makex-web3.com/subscriptions), enter your webhook URL, and set your filters (address, token, sender, receiver, etc.).
